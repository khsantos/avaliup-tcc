        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="bg-white shadow-sm">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between py-4">
                    ...
                    <div className="flex items-center">
                        <img
                            src="/logo.svg" // Substitua pelo caminho da sua logo
                            alt="Logo Avali.up"
            ...
            <div className="max-w-4xl mx-auto p-8 bg-white shadow-md rounded-md">
                ...
                <div className="flex items-center mb-6">
                    ...
                    <div className="ml-4">
                        <p className="text-lg font-semibold">Bem vindo(a), Alessandra Ramos!</p>
                        <p className="text-sm text-gray-600">alessandraramos@gmail.com</p>
                    </div>
                </div>
