...
export function UserMenu({
  ...
  const trigger =
    variant === "desktop" ? (
      ...
      <DropdownMenuTrigger asChild>
        <button className="w-full px-3 py-2 rounded-md bg-white text-[#010b62] dark:bg-[#030712] dark:text-white border border-[#010b62] dark:border-white hover:bg-[#0969da]/15 dark:hover:bg-[#00afd3]/30 transition text-sm font-medium">
          Meu perfil
        </button>
      </DropdownMenuTrigger>
    );
