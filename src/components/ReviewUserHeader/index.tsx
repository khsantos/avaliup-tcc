    ...
    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-2 gap-2 sm:gap-0 w-full">
      <div className="flex flex-col gap-1 sm:gap-2">
        <div className="flex items-start gap-2">
          <Avatar className="w-12 h-12 border-[#010b62] text-[#010b62] dark:text-[#01BAEF]/70 border dark:border-[#01BAEF]/70">
        ...
        <span className="text-xs text-[#010b62]/50 dark:text-gray-400 mt-1">
