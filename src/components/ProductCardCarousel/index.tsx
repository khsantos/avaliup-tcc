...
function ProductCardCarousel({ id, rank, name, rating, image }: Product) {
  ...
  return (
    ...
    >
      ...
      <h3 className="text-[#010b62] dark:text-white text-sm font-medium line-clamp-2 h-[40px] mb-2">
        {name}
      </h3>

      <div className="relative w-28 h-28 my-4 mx-auto flex-shrink-0">
        <Image
          src={image}
          alt={`Imagem do ${name}`}
          width={120}
      ...
      <div className="flex flex-col justify-end flex-grow">
        ...
        <button
          ...
          className={`bg-[#010b62] hover:bg-[#010b62]/80 dark:bg-[#01BAEF] dark:hover:bg-[#01BAEF]/80 transition text-white font-medium text-sm px-4 py-2 rounded w-full mt-3 flex justify-center items-center cursor-pointer`}
        >
          {btnLoading ? (
            <>
              <svg
...
export default React.memo(ProductCardCarousel);
